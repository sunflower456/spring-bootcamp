package beforejava8.assign05.util;

import java.util.ArrayList;
import java.util.List;

import beforejava8.assign05.domain.entity.Birthday;
import beforejava8.assign05.domain.entity.Consultant;
import beforejava8.assign05.domain.entity.Contact;
import beforejava8.assign05.domain.entity.ContactType;
import beforejava8.assign05.domain.entity.Customer;
import beforejava8.assign05.domain.entity.GenderType;
...
public class Generator {
	...
	public static List<Consultant> generateConsultants() {
		...
		consultants.add(new Consultant(200, "이상담", 1));
